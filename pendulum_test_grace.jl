# @with_kw is a decorator, allows default values and keyword constructor
@with_kw struct PendulumMDP <: POMDP{Array{Float64}, Float64, Array{Float32}}
    ...
    ω0 = Distributions.Uniform(-1., 1.) # Disstribution to sample initial angular velocity
...
function POMDPs.gen(mdp::PendulumMDP, s, a, rng::AbstractRNG = Random.GLOBAL_RNG)
    ...
    a = a[1]
    a = clamp(a, -mdp.max_force, mdp.max_force)
